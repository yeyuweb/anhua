...
<tr>
<td><?php echo L('shopname')?></td>
<td>
<input type="text" name="info[shopname]" value="<?php echo $shopname?>" class="input-text" id="shopname" size="30"></input>
</td>
</tr>
<tr>
<td><?php echo L('shopaddr')?></td>
<td>
<input type="text" name="info[shopaddr]" value="<?php echo $shopaddr?>" class="input-text" id="shopaddr" size="35"></input>
</td>
</tr>
<tr>
<td><?php echo L('machinenum')?></td>
<td>
<input type="text" name="info[machinenum]" value="<?php echo $machinenum?>" class="input-text" id="machinenum" size="30"></input>
</td>
</tr>
