...
<td>
<input type="text" name="info[shopname]" value="" class="input-text" id="shopname" size="30"></input>
</td>
</tr>
<tr>
<td><?php echo L('shopaddr')?></td>
<td>
<input type="text" name="info[shopaddr]" value="" class="input-text" id="shopaddr" size="35"></input>
</td>
</tr>
<tr>
<td><?php echo L('machinenum')?></td>
<td>
<input type="text" name="info[machinenum]" value="" class="input-text" id="machinenum" size="30"></input>
</td>
</tr>
<tr>
