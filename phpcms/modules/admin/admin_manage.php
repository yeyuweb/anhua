...
class admin_manage extends admin {
	...
	public function add() {
		if(isset($_POST['dosubmit'])) {
			...
			$admin_fields = array('username', 'email', 'password', 'encrypt','roleid','realname','shopname','shopaddr','machinenum');
	...
	public function edit() {
		if(isset($_POST['dosubmit'])) {
			...
			$userid = $info['userid'];
			$admin_fields = array('username', 'email', 'roleid','realname','shopname','shopaddr','machinenum');
			foreach ($info as $k=>$value) {
				if (!in_array($k, $admin_fields)){
					unset($info[$k]);
				}
